...
jQuery(document).ready(function($){
	...
	if ( typeof( fcaPcPremiumData ) === 'undefined' ) {
		...
		$( disabled ).prop('checked', false).prop('disabled', true).closest('tr').addClass('fca-pc-integration-disabled')
	...
	} else if ( fcaPcPremiumData.package === 'Personal' ) {
		var disabled =
			'.fca-pc-woo_feed' + ', ' +
			'.fca-pc-woo_integration' + ', ' +	
			'.fca-pc-woo_extra_params' + ', ' +	
	...
	$('.fca_pc_pro_tooltip, .fca_pc_tooltip, .fca_pc_event_tooltip').tooltipster( { contentAsHTML: true, theme: ['tooltipster-borderless', 'tooltipster-pixel-cat'] } )
